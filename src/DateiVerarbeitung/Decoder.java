...
public class Decoder
{
	...
	public static String decodeCommand(int index)
	{
		...
		case 0b11_1001_0000_0000:
			return "ANDLW";// ANDLW;

		case 0b11_1000_0000_0000:
			return "IORLW";// IORLW;

		case 0b11_1010_0000_0000:
			return "XORLW";// XORLW;

		}

		switch (command & MASK_LAST_4) {
		case 0b01_0000_0000_0000:
			return "BCF";// BCF;

		case 0b01_0100_0000_0000:
			return "BSF";// BSF;

		case 0b01_1000_0000_0000:
			return "BTFSC";// BTFSC;

		case 0b01_1100_0000_0000:
			return "BTFSS";// BTFSS;

		case 0b11_0000_0000_0000:
			return "MOVLW";// MOVELW;

		case 0b11_0100_0000_0000:
			return "RETLW";// RETLW;
		...
		case 0b11_1110_0000_0000:
			return "ADDLW";// ADDLW;

		case 0b11_1100_0000_0000:
			return "SUBLW";// SUBLW;
